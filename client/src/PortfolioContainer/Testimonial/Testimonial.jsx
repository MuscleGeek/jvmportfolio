  ...
  return (
    <div>
            ...
            >
                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      I patronized Jonathan and when He delivered, I honestly
                  ...
                  <div className="client-info">
                    <img src="img/testi2.jpg" alt="Oops!, Something went wrong"></img>
                    <h5>Daisy Dominic</h5>
                    <p>CEO InansGlobal</p>
                  </div>
                </div>
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src="img/testi4.jpg" alt="Oops!, Something went wrong"></img>
                    <h5>Mikel Niah</h5>
                    <p>CEO MikeTech</p>
                  </div>
                </div>
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src="img/testi1.jpg" alt="Oops!, Something went wrong"></img>
                    <h5>Thomas Slovak</h5>
                    <p>Cibersecurity Engineer</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src="img/testi3.jpg" alt="Oops!, Something went wrong"></img>
                    <h5>Marie-Ann Smith</h5>
      ...
      <div className="footer-image">
        <img src="img/shape-bg.png" alt="Oops!, Something went wrong!" />
      </div>
    </div>
  );
}
